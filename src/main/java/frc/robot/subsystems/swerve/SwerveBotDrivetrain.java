...
public class SwerveBotDrivetrain extends Swerve {
  ...
  public SwerveBotDrivetrain(AHRS gyro) {
    ...
    // TODO - set values
    mod0 = new SwerveModuleBuilder(new Translation2d(.34 / 2, -.27 / 2), // 55, 68 ID 21 Back Left, ID 23 Front Right, ID 25 Front Left, ID 27 Back Right
    ...
    mod1 = new SwerveModuleBuilder(new Translation2d(.34 / 2, .27 / 2),
      SWERVE_MODULE_PRESETS.SDS_MK4i_L2)
      .driveNEO1650(13).turnNEO1650(14)
      .CANCoder(25, 0)
      .driveFeedforward(feedforward).drivePID(DRIVE_PID).build(); //good
    mod2 = new SwerveModuleBuilder(new Translation2d(-.34 / 2, -.27 / 2),
      SWERVE_MODULE_PRESETS.SDS_MK4i_L2)
      .driveNEO1650(12).turnNEO1650(11)
      .CANCoder(27, 0)
      .driveFeedforward(feedforward).drivePID(DRIVE_PID).build();
    mod3 = new SwerveModuleBuilder(new Translation2d(-.34 / 2, .27 / 2),
      SWERVE_MODULE_PRESETS.SDS_MK4i_L2)
