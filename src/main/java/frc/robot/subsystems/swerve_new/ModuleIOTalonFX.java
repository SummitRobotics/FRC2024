...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.drivePositionRad =
        Units.rotationsToRadians(drivePosition.getValueAsDouble()) / preset.driveGearRatio;
    inputs.driveVelocityRadPerSec =
        Units.rotationsToRadians(driveVelocity.getValueAsDouble()) / preset.driveGearRatio;
    ...
    inputs.turnPosition =
        Rotation2d.fromRotations(turnPosition.getValueAsDouble() / preset.turnGearRatio);
    inputs.turnVelocityRadPerSec =
        Units.rotationsToRadians(turnVelocity.getValueAsDouble()) / preset.turnGearRatio;
